class Human:
    ...
    def __str__(self):
        name = 'Антон'
        fridge = None
        result = f"Имя: {name}, fridge: {fridge or 'отсутствует'}"
        return result
...
class House:
    def __init__(self, fridge: 'Refrigerator' = None | object, bedside_table: 'Nightstand' = None | object):
        self.fridge = fridge
        self.bedside_table = bedside_table

    def add_refrigerator(self, fridge: 'Refrigerator' = None | object):
        self.fridge = fridge

    def add_nightstand(self, bedside_table: 'Nightstand' = None | object):
        self.bedside_table = bedside_table

    def __str__(self):
        return f'{self.fridge.food}, {self.bedside_table.money}'
...
def main():
    import random
    humans = [init_human(name='Anton'), init_human(name='Anna')]
    home = init_home()
    for human in humans:
